...
interface WorkingCapitalSectionConfig {
  key: string;
  legend: string;
...
@Component({
  selector: 'app-cassava-working-capital-section',
  standalone: true,
...
export class CassavaWorkingCapitalSectionComponent implements OnInit, OnDestroy {
  readonly sections: WorkingCapitalSectionConfig[] = [
    {
      key: 'accounts_receivable',
      legend: 'Accounts Receivable & Other Assets',
      requiredColumns: ['Effective Month', 'Metric', 'Value', 'Units'],
      priorityColumns: ['Effective Month', 'Metric', 'Value', 'Units'],
      scrollHeight: '230px',
    },
    {
      key: 'inventory_payable',
      legend: 'Accounts Payable',
      requiredColumns: ['Effective Month', 'Metric', 'Value', 'Units'],
      priorityColumns: ['Effective Month', 'Metric', 'Value', 'Units'],
      scrollHeight: '210px',
    },
  ...
  isNumericColumn(column: string): boolean {
    return /value|days|rate|amount|cost|%/i.test(column);
  }
  ...
  private sectionByKey(tableKey: string): WorkingCapitalSectionConfig | undefined {
