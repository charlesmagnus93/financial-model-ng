  ...
  template: `
    <p-fluid class="flex">
      <div class="card flex flex-col gap-4 w-full fp-10">
        <div class="text-xl font-semibold">Overdraft</div>
          ...
          <div class="overflow-auto">
            <div class="min-w-[900px]">
              <div class="grid grid-cols-12 gap-2 text-xs font-semibold pb-2">
                ...
                <div class="col-span-3">Overdraft Balance</div>
        ...
        <div>
          <div class="text-lg font-semibold mb-2">
            Overdraft Amortisation Schedule
          </div>
          <div class="overflow-auto">
            <p-table
              [value]="amortization"
            ...
            >
              <ng-template pTemplate="header">
                <tr class="text-left text-surface-300">
                  ...
                  <th class="px-2 py-2">Remaining Overdraft Balance</th>
                </tr>
              </ng-template>
        ...
        <div class="border-t border-surface-800 pt-4">
          <div class="text-lg font-semibold mb-3">Add overdraft</div>
          <form
          ...
          >
            ...
            <div class="col-span-3">
              <div class="text-sm font-semibold mb-1">Overdraft Balance</div>
              <p-inputnumber
                formControlName="balance"
                mode="decimal"
                [minFractionDigits]="4"
...
export class OverdraftWidget implements OnInit {
  ...
  get amortization(): AmortizationRow[] {
    ...
    rows.forEach((r) => {
      ...
      for (let i = 0; i < r.duration; i++) {
        ...
        const interestPayment = opening * this.overdraftRate;
  ...
  private createRow(values: Partial<OverdraftRow>): FormGroup {
