...
import { BiotechUsesSourcesFundsFieldsetComponent } from "./biotech-uses-sources-funds-fieldset.component";
import { BiotechDebtScheduleInputsFieldsetComponent } from "./biotech-debt-schedule-inputs-fieldset.component";
import { BiotechRiskAdjustedDcfValuationMethodFieldsetComponent } from "./biotech-risk-adjusted-dcf-valuation-method-fieldset.component";
...
@Component({
  ...
  imports: [
    ...
    BiotechUsesSourcesFundsFieldsetComponent,
    BiotechDebtScheduleInputsFieldsetComponent,
    BiotechRiskAdjustedDcfValuationMethodFieldsetComponent,
  ...
  template: `
    ...
    <biotech-uses-sources-funds-fieldset></biotech-uses-sources-funds-fieldset>
    <biotech-debt-schedule-inputs-fieldset></biotech-debt-schedule-inputs-fieldset>
    <biotech-risk-adjusted-dcf-valuation-method-fieldset></biotech-risk-adjusted-dcf-valuation-method-fieldset>
