...
@Component({
  standalone: true,
  selector: 'tablet-price-widget',
  imports: [CommonModule, TableModule, NgChartsModule],
  template: `
    <div class="card flex flex-col gap-6 w-full">
      <div class="text-xl font-semibold">tablet_price</div>
      ...
      <div class="space-y-2">
        <div class="text-sm font-semibold text-surface-300">tablet_price Sensitivity Trend</div>
        <div class="h-80">
          <canvas
            baseChart
            [type]="lineType"
...
export class TabletPriceWidget implements OnInit {
  rows: TabletPriceRow[] = [];
