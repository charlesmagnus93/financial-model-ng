...
@Component({
  ...
  template: `
    <div class="card w-full flex flex-col gap-4">
      <div class="text-2xl font-semibold">Decision Tree Tools</div>
...
export class ScenarioToolConfigurationWidget implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const result = output?.scenario_tool_results?.decision_tree ?? {};
