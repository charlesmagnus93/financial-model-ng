...
@Component({
  standalone: true,
  selector: 'indirect-labor-widget',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    InputNumberModule,
  ...
  template: `
    <p-fluid class="flex">
      <div class="card flex flex-col gap-4 w-full fp-10">
        <div class="text-xl font-semibold">Indirect Labour Structure</div>
        ...
        <div class="border-t border-surface-800 pt-4">
          <div class="text-lg font-semibold mb-3">Add indirect labour role</div>
          <form
...
export class IndirectLaborWidget implements OnInit {
  form: FormGroup;
