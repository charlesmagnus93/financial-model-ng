...
@Component({
  ...
  template: `
    <div class="card w-full flex flex-col gap-4">
      <div class="text-2xl font-semibold">Real Options Analysis (ROA)</div>
...
export class RoaWidget implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const result = output?.scenario_tool_results?.real_options ?? {};
