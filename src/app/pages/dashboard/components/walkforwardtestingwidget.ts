...
@Component({
  standalone: true,
  selector: 'walk-forward-testing-widget',
  imports: [CommonModule, TableModule],
  template: `
    <div class="card w-full flex flex-col gap-4">
      <div class="text-2xl font-semibold">Walk-forward Testing</div>
...
export class WalkForwardTestingWidget implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const result = output?.scenario_tool_results?.walk_forward ?? {};
